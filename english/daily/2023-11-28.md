...
**shipment**: means to deliver a huge group goods to somewhere
...
pull out: means to move out something from the somewhere to another place.

The stocker said they `pulled out` the goods from the shelves, casue they are in the qulity control issue.

## 7. discontinue / no longer to do
discontinue means to stop the status.

+ The supermarket discontinue to sell the chocolates.
+ The supermarket is no longer to sell the chocolates.

## 8. quility control issues.



## 9. out of season

**out of season** means the timing is not right. 

We provider the watermelons in summer. It's autumn now, so the watermelons are out of season.


## 10. nothing to show it / go home empty hand

**nothing to show it / go home empty hand** means you have nothing. When you come out from a supermarket, you have **nothing to show it** or you **go home empty hand** means you buy nothing from the supermarket.

## 11. I'm there. / I'm in.

It is to means you are going to join them. 

For example, your friend asks you to watch a movie/film. You say `I'm in` or `I'm there`, means you agree with your friend, and you promise you will go with him. Perhaps you don't go at last.


## 12. organic

有机的。 有机苹果 organic apples
...
+ **neither do i** is more commonly used. 
+ **nor to i** can be used in some strict situation.

![](./images/neither-do-i-and-nor-do-i.jpg)
![](./images/so-do-i-and-neither-do-i.jpg)
